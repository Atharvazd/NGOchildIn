...
module.exports = {
    ...
    insertChild: function(name, dob, gender, description, callback) {
        const time_created = helper.getCurrentMySQLDate();
        DBConnector.query("INSERT INTO " + CHILD_TABLE_NAME + " (" + CHILD_FIELDS.NAME + ", " + CHILD_FIELDS.GENDER + ", " + CHILD_FIELDS.DOB + ", " + CHILD_FIELDS.DESCRIPTION + ", " +
            CHILD_FIELDS.TIME_CREATED + ") VALUES ('" +
